...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x316f
#define DXLIB_VERSION_STR_T _T("3.16f")
#define DXLIB_VERSION_STR_W   L"3.16f"
...
extern	int			DrawRoundRectAA(  float x1, float y1, float x2, float y2, float rx, float ry,                     unsigned int Color, int FillFlag, float LineThickness = 1.0f ) ;			// 角の丸い四角形を描画する( アンチエイリアス付き )
